...
//   const products = [
//     { name: 'Industrial Pump', category: 'Industrial Equipment', image: '/placeholder.svg?height=300&width=300', price: '$1,999.99' },
//     { name: 'Office Chair', category: 'Office Supplies', image: '/placeholder.svg?height=300&width=300', price: '$199.99' },
//     { name: 'Safety Helmet', category: 'Safety Gear', image: '/placeholder.svg?height=300&width=300', price: '$49.99' },
//     { name: 'Laptop', category: 'Electronics', image: '/placeholder.svg?height=300&width=300', price: '$999.99' },
//     { name: 'Industrial Cleaner', category: 'Chemicals', image: '/placeholder.svg?height=300&width=300', price: '$29.99' },
//     { name: 'Conveyor Belt', category: 'Industrial Equipment', image: '/placeholder.svg?height=300&width=300', price: '$2,999.99' },
//     { name: 'Printer', category: 'Office Supplies', image: '/placeholder.svg?height=300&width=300', price: '$399.99' },
//     { name: 'Safety Goggles', category: 'Safety Gear', image: '/placeholder.svg?height=300&width=300', price: '$19.99' },
//     { name: 'Smartphone', category: 'Electronics', image: '/placeholder.svg?height=300&width=300', price: '$699.99' },
//     { name: 'Lubricant', category: 'Chemicals', image: '/placeholder.svg?height=300&width=300', price: '$14.99' },
//     { name: 'Forklift', category: 'Industrial Equipment', image: '/placeholder.svg?height=300&width=300', price: '$24,999.99' },
//     { name: 'Filing Cabinet', category: 'Office Supplies', image: '/placeholder.svg?height=300&width=300', price: '$299.99' },
//   ]
...
//                 ':hover': {
//                   backgroundColor: selectedCategory === category ? '#3A006F' : '#e0e0e0'
//                 }
//               }}
//             >
//               {category}
...
//               <p style={{ fontSize: '18px', fontWeight: 'bold', color: '#4B0082' }}>{product.price}</p>
//             </div>
//           </div>
//         ))}
//       </div>
